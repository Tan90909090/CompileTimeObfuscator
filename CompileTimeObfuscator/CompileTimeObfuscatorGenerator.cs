...
public partial class CompileTimeObfuscatorGenerator : IIncrementalGenerator
{
    ...
    public const string PropertyNameClearBufferWhenDispose = "ClearBufferWhenDispose";
    public const string DefaultValueClearBufferWhenDispose = "true";
    ...
    private readonly record struct AttributeArgument(TypedConstant TypedConstantForValueParameter, int KeyLength, bool ClearBufferWhenDispose);
        ...
        string fullyQualifiedAttributeName)
    {
        ...
        bool clearBufferWhenDispose = GetNamedArgumentOrDefault(PropertyNameClearBufferWhenDispose, bool.Parse(DefaultValueClearBufferWhenDispose));
        ...
        return new AttributeArgument(typedConstantForValueParameter, keyLength, clearBufferWhenDispose);
    }
        ...
        ObfuscationType obfuscationType)
    {
        if (fullyQualifiedAttributeName == FullyQualifiedClassNameObfuscatedStringAttribute)
        {
            ...
            return XorObfuscator.GenerateMethodBodyCodeForDeobfuscateString(
                ...
                attributeArgument.ClearBufferWhenDispose,
